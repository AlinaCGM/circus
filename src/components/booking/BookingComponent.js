    ...
    <Container className="containerStyle">
      ...
      <Row className="mb-5">
        <Col md={12}>
          ...
          <ListGroup>
            <ListGroup.Item>
              December 5, 2023 - "Circus Spectacular" -{" "}
              <Button variant="warning" onClick={toggleDetails}>
                {showDetails ? "Hide Details" : "Show Details"}
              </Button>
              {showDetails && (
            ...
            <ListGroup.Item>
              December 12, 2023 - "Amazing Acrobatics " -{" "}
              <Button variant="warning" onClick={toggleDetails1}>
                {showDetails1 ? "Hide Details" : "Show Details"}
              </Button>
              {showDetails1 && (
            ...
            <ListGroup.Item>
              December 19, 2023 - "Circus Extravaganza -{" "}
              <Button variant="warning" onClick={toggleDetails2}>
                {showDetails2 ? "Hide Details" : "Show Details"}
              </Button>
              {showDetails2 && (
      ...
      <Row>
        <Col md={12}>
          ...
          <ListGroup>
            <ListGroup.Item>
              January 5, 2023 - "Circus Spectacular" -{" "}
              <Button variant="warning" onClick={toggleDetails}>
                {showDetails ? "Hide Details" : "Show Details"}
              </Button>
              {showDetails && (
            ...
            <ListGroup.Item>
              January 12, 2023 - "Amazing Acrobatics " -{" "}
              <Button variant="warning" onClick={toggleDetails1}>
                {showDetails1 ? "Hide Details" : "Show Details"}
              </Button>
              {showDetails1 && (
            ...
            <ListGroup.Item>
              January 19, 2023 - "Circus Extravaganza -{" "}
              <Button variant="warning" onClick={toggleDetails2}>
                {showDetails2 ? "Hide Details" : "Show Details"}
              </Button>
              {showDetails2 && (
